...
let args = Object.assign({}, DomainResourceArgs, ResourceArgs, MediaArgs);

// Resolvers
const { getMedia, getMediaList, getMediaInstance, getMediaByEncounterId } = require('./resolver');
...
/**
 * @name exports.MediaByEncounterIdQuery
 * @summary Media query.
 */
module.exports.MediaByEncounterIdQuery = {
	description: 'Access information about a single Media',
	resolve: scopeInvariant(scopeOptions, getMediaByEncounterId),
	type: MediaSchema,
	args: args,
};
