...
/**
 * @name exports.EncounterByPatientIdQuery
 * @summary Encounter query.
 */
module.exports.EncounterByPatientIdQuery = {
	description: 'Query Encounters by Patient Id',
	resolve: scopeInvariant(scopeOptions, getEncounterByPatientId),
	type: EncounterSchema,
	args: args,
};